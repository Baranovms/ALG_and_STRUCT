...
// на основе материалов Sergey Arkhipov Java Tutorials
...
public class task1 {
    public static void main(String[] args) {
        ...
        contactList.addToEnd(new Contact(456, "Иванов Иван Иванович", "+79765847596"));
        contactList.addToEnd(new Contact(678, "Горбачев Станислав Степанович", "+79241569856"));
        contactList.addToEnd(new Contact(789, "Павлова Татьяна Евгеньевна", "+79623584986"));
